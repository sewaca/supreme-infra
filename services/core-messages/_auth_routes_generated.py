...
AUTH_ROUTES: list[AuthRoute] = [
    ...
    AuthRoute(path=re.compile(r"^/core-messages/conversations/[^/]+/messages/[^/]+$"), method='DELETE', auth_level="valid"),
    AuthRoute(path=re.compile(r"^/core-messages/conversations/[^/]+/messages/[^/]+$"), method='PATCH', auth_level="valid"),
