...
const generateDormitoryOrders = (): Order[] =>
  Array.from({ length: 50 }, (_, i) => ({
    ...
    comment: `№${100 + i}/д от ${String(Math.floor(Math.random() * 28) + 1).padStart(2, '0')}.${String(Math.floor(Math.random() * 12) + 1).padStart(2, '0')}.2026`,
...
const generateScholarshipOrders = (): Order[] =>
  Array.from({ length: 50 }, (_, i) => ({
    ...
    date: `${String(Math.floor(Math.random() * 28) + 1).padStart(2, '0')}-${String(Math.floor(Math.random() * 12) + 1).padStart(2, '0')}-2026`,
    comment: `№${250 + i}/кс от ${String(Math.floor(Math.random() * 28) + 1).padStart(2, '0')}.${String(Math.floor(Math.random() * 12) + 1).padStart(2, '0')}.2026\nГАС ИТПИ ${i % 2 === 0 ? '1' : '2'} сем 25/26`,
...
const generateEducationOrders = (): Order[] =>
  Array.from({ length: 50 }, (_, i) => ({
    ...
    title: 'О зачислении',
    date: `${String(Math.floor(Math.random() * 28) + 1).padStart(2, '0')}-${String(Math.floor(Math.random() * 12) + 1).padStart(2, '0')}-2026`,
    comment: `№${400 + i}/о от ${String(Math.floor(Math.random() * 28) + 1).padStart(2, '0')}.${String(Math.floor(Math.random() * 12) + 1).padStart(2, '0')}.2026`,
    startDate: '01-09-2025',
    endDate: '30-06-2030',
    educationForm: 'Очная',
    educationType: 'Бюджет',
...
const generateGeneralOrders = (): Order[] =>
  Array.from({ length: 50 }, (_, i) => ({
    ...
    title: 'Общий приказ',
    date: `${String(Math.floor(Math.random() * 28) + 1).padStart(2, '0')}-${String(Math.floor(Math.random() * 12) + 1).padStart(2, '0')}-2026`,
    comment: `№${600 + i}/п от ${String(Math.floor(Math.random() * 28) + 1).padStart(2, '0')}.${String(Math.floor(Math.random() * 12) + 1).padStart(2, '0')}.2026`,
