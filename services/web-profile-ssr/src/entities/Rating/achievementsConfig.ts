...
export const ACHIEVEMENT_CONFIGS: Record<AchievementType, Omit<Achievement, 'unlocked' | 'unlockedAt' | 'progress' | 'maxProgress' | 'timesEarned'>> = {
  excellent_student: {id: 'excellent_student', title: 'Отличник', description: 'Средний балл 4.6 и выше', icon: '🏆'},
  unstoppable: {id: 'unstoppable', title: 'Неудержимый', description: 'Вошёл в топ 10% по посещаемости за всё время', icon: '🔥'},
  ...
  communicative: {id: 'communicative', title: 'Коммуникабельный', description: 'Вошёл в топ 5% по сообщениям в ЛК', icon: '💬'},
  early_bird: {id: 'early_bird', title: 'Ранняя пташка', description: 'Ни разу не пропустил первую пару за семестр', icon: '🌅'},
