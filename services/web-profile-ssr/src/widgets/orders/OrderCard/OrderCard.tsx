...
export const OrderCard = ({ order, onClick }: Props) => {
  ...
  return (
    <Card variant="outlined" sx={{ borderRadius: 2, backgroundColor: 'var(--color-background)' }}>
      <CardActionArea onClick={onClick} sx={{ p: 2, backgroundColor: 'var(--color-background)' }}>
