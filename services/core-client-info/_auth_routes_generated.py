...
AUTH_ROUTES: list[AuthRoute] = [
    ...
    AuthRoute(
        path=re.compile(r"^/core-client-info/profile/search-for-registration$"), method="POST", auth_level="none"
    ),
    ...
    AuthRoute(
        path=re.compile(r"^/core-client-info/subjects/choices-with-priorities$"), method="GET", auth_level="valid"
    ),
