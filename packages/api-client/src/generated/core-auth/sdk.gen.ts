 ...
 * Lookup
 */
export const lookupAuthLookupPost = <ThrowOnError extends boolean = false>(options: Options<LookupAuthLookupPostData, ThrowOnError>) => (options.client ?? client).post<LookupAuthLookupPostResponses, LookupAuthLookupPostErrors, ThrowOnError>({
    url: '/auth/lookup',
    ...options,
    headers: {
        'Content-Type': 'application/json',
