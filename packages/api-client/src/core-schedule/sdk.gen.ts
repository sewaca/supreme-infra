 ...
 * Teacher Schedule
 */
export const teacherScheduleTeachersTeacherNameScheduleGet = <ThrowOnError extends boolean = false>(options: Options<TeacherScheduleTeachersTeacherNameScheduleGetData, ThrowOnError>) => (options.client ?? client).get<TeacherScheduleTeachersTeacherNameScheduleGetResponses, TeacherScheduleTeachersTeacherNameScheduleGetErrors, ThrowOnError>({ url: '/teachers/{teacher_name}/schedule', ...options });

/**
 * Teacher Exams
 */
export const teacherExamsTeachersTeacherNameExamsGet = <ThrowOnError extends boolean = false>(options: Options<TeacherExamsTeachersTeacherNameExamsGetData, ThrowOnError>) => (options.client ?? client).get<TeacherExamsTeachersTeacherNameExamsGetResponses, TeacherExamsTeachersTeacherNameExamsGetErrors, ThrowOnError>({ url: '/teachers/{teacher_name}/exams', ...options });

/**
 * Teacher Template
 */
export const teacherTemplateTeachersTeacherNameTemplateGet = <ThrowOnError extends boolean = false>(options: Options<TeacherTemplateTeachersTeacherNameTemplateGetData, ThrowOnError>) => (options.client ?? client).get<TeacherTemplateTeachersTeacherNameTemplateGetResponses, TeacherTemplateTeachersTeacherNameTemplateGetErrors, ThrowOnError>({ url: '/teachers/{teacher_name}/template', ...options });
